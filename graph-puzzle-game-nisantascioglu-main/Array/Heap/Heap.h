...
#ifndef GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_HEAP_H
#define GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_HEAP_H
...
#endif //GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_HEAP_H
