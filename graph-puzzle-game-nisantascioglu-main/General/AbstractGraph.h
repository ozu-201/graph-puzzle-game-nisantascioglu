...
#ifndef GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_ABSTRACTGRAPH_H
#define GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_ABSTRACTGRAPH_H
...
#endif //GRAPH_PUZZLE_GAME_NISANTASCIOGLU_MAIN_ABSTRACTGRAPH_H
